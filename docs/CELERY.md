...
```bash
CELERY_BROKER_URL=amqp://info-backend-producer:pass@localhost:5672/tpl-development
...
| 说明 | 模板 / 实例 |
|------|-------------|
| 应用代码 | `tpl-app/info-backend/app/` |
| celeryworker 模板 | `tpl-app/celeryworker-info-backend/` |
