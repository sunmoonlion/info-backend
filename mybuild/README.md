...
--context       <子模块根目录>
--build-arg     REGISTRY=harbor.sunmoonai.com:30443/k8s-images
--destination   harbor.sunmoonai.com:30443/k8s-images/info-backend:<git-sha>
--destination   harbor.sunmoonai.com:30443/k8s-images/info-backend:latest
```
